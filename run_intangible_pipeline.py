...
# 포스트 정보
POST_TITLE = "무형자산의 감가상각 - 회계처리 완벽 가이드"
POST_SLUG = "intangible-asset-amortization"
POST_EXCERPT = "무형자산의 정의, K-IFRS 회계기준, 상각방법, 내용연수 결정, 손상검사, 영업권 처리까지 무형자산 감가상각을 체계적으로 정리한 슬라이드입니다."
POST_CATEGORY = "finance"
POST_TAGS = ["무형자산", "감가상각", "상각", "K-IFRS", "IAS38", "영업권", "내용연수", "재무회계"]
ADMIN_URL = "https://profile-blue-pi.vercel.app"

# NotebookLM 설정
NLM_TITLE = "무형자산의 감가상각"
NLM_SOURCES = [
    "https://ko.wikipedia.org/wiki/%EB%AC%B4%ED%98%95%EC%9E%90%EC%82%B0",
...
- 영어는 전문용어만 괄호 안에
- 슬라이드 10장
- 핵심 주제: 무형자산의 감가상각 (Amortization of Intangible Assets)
- 구성: 정의 → 회계기준(K-IFRS/IAS38) → 무형자산 분류 → 내용연수 결정 → 상각방법 → 영업권 처리 → 손상검사 → 공시요구사항 → 세무처리 → 요약"""
